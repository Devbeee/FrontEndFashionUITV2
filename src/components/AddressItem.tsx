  ...
  return (
    ...
    >
      <div className='flex justify-between w-full'>
        <div className='flex items-start gap-2 text-xl font-bold'>
          ...
          <span className=' hover:opacity-85 flex items-center'>
            {address.name}
            {isDefault && <Badge className='ml-4' count={'Mặc định'} style={{ backgroundColor: '#52c41a' }} />}
          </span>
        </div>
        <div className='flex gap-3'>
          {!isDefault ? (
            ...
            <div className='text-gray-600'>Mặc định</div>
          )}
          <Popconfirm
            title='Xóa địa chỉ'
      ...
      <div className='flex flex-col items-start gap-1 text-base'>
        ...
        <div className='xl:max-w-[720px] max-w-[60vw] overflow-hidden text-left truncate text-ellipsis'>
